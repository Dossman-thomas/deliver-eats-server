...
"/", auth_1.jwtCheck, MyUserController_1.default.createCurrentUser);
router.put(// API endpoint to update a user 
"/", auth_1.jwtCheck, auth_1.jwtParse, validation_1.validateMyUserRequest, MyUserController_1.default.updateCurrentUser);
